...
// - This is loopDone automatically on iOS, Android and Emscripten targets.
...
//  2021-01-03: OpenGL: Backup, SetupImGui and restore GL_STENCIL_TEST state.
//  2020-10-23: OpenGL: Backup, SetupImGui and restore GL_PRIMITIVE_RESTART state.
...
//  2018-06-08: OpenGL: Use draw_data->DisplayPos and draw_data->DisplaySize to SetupImGui projection matrix and clipping rectangle.
//  2018-05-25: OpenGL: Removed unnecessary backup/restore of GL_ELEMENT_ARRAY_BUFFER_BINDING since this is part of the VAO state.
//  2018-05-14: OpenGL: Making the call to glBindSampler() optional so 3.2 context won't fail if the function is a nullptr pointer.
//  2018-03-06: OpenGL: Added const char* glsl_version parameter to ImGui_ImplOpenGL3_Init() so user can override the GLSL version e.g. "#version 150".
//  2018-02-23: OpenGL: Create the VAO in the render function so the SetupImGui can more easily be used with multiple shared GL context.
...
bool    ImGui_ImplOpenGL3_Init(const char* glsl_version)
{
    ...
    // SetupImGui backend capabilities flags
...
static void ImGui_ImplOpenGL3_SetupRenderState(ImDrawData* draw_data, int fb_width, int fb_height, GLuint vertex_array_object)
{
    ...
    // SetupImGui render state: alpha-blending enabled, no face culling, no depth testing, scissor enabled, polygon fill
    glEnable(GL_BLEND);
    ...
    // SetupImGui viewport, orthographic projection matrix
    ...
    // Bind vertex/index buffers and SetupImGui attributes for ImDrawVert
