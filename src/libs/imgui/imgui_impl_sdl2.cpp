...
//  2018-03-20: Misc: SetupImGui io.BackendFlags ImGuiBackendFlags_HasMouseCursors flag + honor ImGuiConfigFlags_NoMouseCursorChange flag.
...
void ImGui_ImplSDL2_NewFrame()
{
    ...
    // SetupImGui display size (every frame to accommodate for window resizing)
    int w, h;
    ...
    // SetupImGui time step (we don't use SDL_GetTicks() because it is using millisecond resolution)
